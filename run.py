...
from kalabash_installer import compatibility_matrix
from kalabash_installer import package
from kalabash_installer import scripts
from kalabash_installer import ssl
from kalabash_installer import system
from kalabash_installer import utils
...
def main(input_args):
    ...
    parser.add_argument(
        ...
        help="Kalabash version to install")
    parser.add_argument(
    ...
    utils.printcolor("Welcome to Kalabash installer!\n", utils.GREEN)
    ...
    config.set("kalabash", "version", args.version)
    ...
    scripts.install("kalabash", config, args.upgrade)
    ...
    utils.printcolor(
        "Congratulations! You can enjoy Kalabash at https://{} (admin:password)"
