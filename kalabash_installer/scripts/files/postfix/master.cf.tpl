...
# Kalabash autoreply service
#
autoreply unix        -       n       n       -       -       pipe
  flags= user=%{dovecot_mailboxes_owner}:%{dovecot_mailboxes_owner} argv=%{kalabash_venv_path}/bin/python %{kalabash_instance_path}/manage.py autoreply $sender $mailbox
