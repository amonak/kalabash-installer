...
class Postfix(base.Installer):
    ...
    def get_template_context(self):
        ...
        context.update({
            ...
            "kalabash_venv_path": self.config.get(
                "kalabash", "venv_path"),
            "kalabash_instance_path": self.config.get(
                "kalabash", "instance_path"),
    ...
    def post_run(self):
        """Additional tasks."""
        venv_path = self.config.get("kalabash", "venv_path")
        python_path = os.path.join(venv_path, "bin", "python")
        instance_path = self.config.get("kalabash", "instance_path")
